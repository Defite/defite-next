...
export function ThemeToggle() {
  ...
  return <Menu as="div" className="relative inline-block">
    <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold text-foreground shadow-xs inset-ring-1 inset-ring-gray-300">
